...
def get_user_list(config, key):
    with open("{}/SinonRobot/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    BOT_ID = 5355063405
    TOKEN = "5355063405:AAF8_7JXBQQm0lBFHz_dFpEBIMhD2vddTfM"
    OWNER_ID = 5259108841 # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "ItzAloneX"
    DRAGONS = ""
    DEMONS = ""
    DEV_USERS = ""
    SUPPORT_CHAT = "SinonSupport"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001791135075
    ...
    REM_BG_API_KEY = ""
    GENIUS_API_TOKEN = ""
    MONGO_DB_URI = "mongodb+srv://AloneX:AloneX@cluster0.0hh7x.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
    STRING_SESSION = ""
