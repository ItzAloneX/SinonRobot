...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./SinonRobot/resources/LOGOS/*")
    ...
    fname = "logo.png"
    img.save(fname, "png")
    sinon = [[Button.url("Made By Sinon", "t.me/SinonRobot")]]
    await tbot.send_file(event.chat_id, file=fname,buttons=sinon)
    
    await pesan.delete()
    if os.path.exists(fname):
            os.remove(fname)
 except Exception as e:
    await event.reply(f'Error, Report @SinonSupport, {e}')
