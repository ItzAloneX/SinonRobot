...
from SinonRobot import dispatcher, telethn
from SinonRobot.__main__ import (CHAT_SETTINGS, DATA_EXPORT, DATA_IMPORT,
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("SinonRobot.modules.", 1)[1]
