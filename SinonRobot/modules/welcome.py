...
import SinonRobot.modules.sql.welcome_sql as sql
from SinonRobot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, JOIN_LOGGER)
from SinonRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from SinonRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from SinonRobot.modules.helper_funcs.msg_types import get_welcome_type
from SinonRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from SinonRobot.modules.log_channel import loggable
from SinonRobot.modules.sql.global_bans_sql import is_user_gbanned
...
SINON_IMG = "https://telegra.ph/file/4d1fee917b01de0df08ec.jpg"
SINON = "https://telegra.ph/file/4e23ccbfc3c77195c9bfd.jpg"
SINON_VID = "https://telegra.ph/file/fee04e299006fffe7f9eb.mp4"
WAIFUS_IMG = "https://telegra.ph/file/ad3a6ba302d87017c8e04.jpg"
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                SINON_IMG, caption= "Oh, Genos? Let's get this moving.",
                    reply_to_message_id=reply)
            ...
            # Welcome Sudos
                ...
                SINON, caption= "Huh! A Rank Hunter just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_photo(
                SINON, caption= "Huh! Someone with a B Rank Hunter level just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_photo(
                SINON, caption= "Oof! A C Rank Hunter just joined!",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_photo(
                SINON, caption= "Oof! A D Rank Hunter just joined!",
                    reply_to_message_id=reply)
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_video(
                SINON_VID, caption= "Oi! Genos! He left..", reply_to_message_id=reply)
                return
