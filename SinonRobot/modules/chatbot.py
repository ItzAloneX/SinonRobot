...
import html
import requests
import SinonRobot.modules.sql.chatbot_sql as sql
...
from SinonRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from SinonRobot import dispatcher, updater, SUPPORT_CHAT
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Hey Darling! 💕 Sinon Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Hey Darling! 💕 Sinon Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
