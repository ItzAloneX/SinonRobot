...
from SinonRobot import OWNER_ID, pgram, arq
from SinonRobot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from SinonRobot.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("More Help", url=f"t.me/SinonRobot?start=start"),
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/863327ae7d6a92688b093.jpg",
...
async def alive_function(answers):
   ...
   # ubot_state = 'Dead' if not await app2.get_me() else 'Alive'
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/SinonRobot"),
        InlineKeyboardButton("Go Inline", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[💚 Sinon](https://t.me/SinonRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
**Platform:** `{sys.platform}`
**Profiles:** [BOT](t.me/SinonRobot) | [OWNER](t.me/ItzAloneX)
"""
    ...
    answers.append(
        InlineQueryResultPhoto(
            ...
            thumb_url="https://telegra.ph/file/690196d6c201f5532a41e.jpg",
            photo_url="https://telegra.ph/file/93d5de851fc92a08db359.jpg",
            caption=msg,
            reply_markup=buttons,
        )
    )
