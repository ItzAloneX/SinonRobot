...
from SinonRobot.sinontext import PM_START_TEXT
...
LOGGER = logging.getLogger("[SinonRobot]")
...
if ENV:
    ...
    from SinonRobot.config import Development as Config
    TOKEN = Config.TOKEN
...
print("[SinonRobot]: Initializing AIOHTTP Session")
aiohttpsession = ClientSession() 

#install arq
print("[SinonRobot]: Initializing ARQ Client")
arq = (ARQ_API_URL, ARQ_API_KEY, aiohttpsession)
updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
telethn = TelegramClient(MemorySession(), API_ID, API_HASH)
pbot = Client("SinonRobotpbot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from SinonRobot.modules.helper_funcs.handlers import (CustomCommandHandler,
